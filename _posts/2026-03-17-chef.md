...
![challenge](/assets/images/ramadan_ctf_2026/chef/chef_challenge.png)
...
Opening the binary in Ghidra, we discover an "Iftar Kitchen" menu with 4 options: allocate a pot, free a pot, write to a pot, and taste (read) a pot.
