...
tags: [pwn, rop, writeup, securinets , isi , easy , hyzr]
---
...
![file and checksec output](/assets/images/friendly_isi_2025/time_to_act_1/file_checksec_ttact1.png)
...
![binary output](/assets/images/friendly_isi_2025/time_to_act_1/test_ttact1.png)
...
![gdb info func output](/assets/images/friendly_isi_2025/time_to_act_1/gdb_ttact1.png)
...
![disassembly of main function](/assets/images/friendly_isi_2025/time_to_act_1/disass_main_ttact1.png)

- the main calls vuln function , let's see what happens in it by disassembling it aswell using **disass vuln**

![disassembly of vuln function](/assets/images/friendly_isi_2025/time_to_act_1/disass_vuln_ttact1.png)
...
![strings and grep output](/assets/images/friendly_isi_2025/time_to_act_1/strings_ttac1_binsh.png)
...
![pop rdi ret address](/assets/images/friendly_isi_2025/time_to_act_1/ttact1_pop_rdi.png)

![ret address](/assets/images/friendly_isi_2025/time_to_act_1/ttac1_ret_ropper.png)
...
![solver.py output](/assets/images/friendly_isi_2025/time_to_act_1/ttact1_solver.png)
