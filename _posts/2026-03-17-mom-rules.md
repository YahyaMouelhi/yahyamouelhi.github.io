...
![challenge](/assets/images/ramadan_ctf_2026/mom_rules/mom_rules_challenge.png)
...
![file and checksec](/assets/images/ramadan_ctf_2026/mom_rules/mom_rules_file_checksec.png)
...
- **`wash_hands(rdi, rsi)`** -- Computes `rdi % rsi` (remainder), then calls `open("flag.txt", number, 0)` and stores the returned file descriptor in `fd`. Prints "Now im gonna wash my hands".
...
![ghidra functions](/assets/images/ramadan_ctf_2026/mom_rules/mom_rules_ghidra.png)
...
![flag](/assets/images/ramadan_ctf_2026/mom_rules/mom_rules_flag.png)
