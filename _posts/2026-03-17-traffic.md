...
![challenge](/assets/images/ramadan_ctf_2026/traffic/traffic_challenge.png)
...
```python
for i in range(1, 30):
    # send %N$p to print the N-th stack argument
```
...
![leak](/assets/images/ramadan_ctf_2026/traffic/traffic_leak.png)
...
![flag](/assets/images/ramadan_ctf_2026/traffic/traffic_flag.png)
